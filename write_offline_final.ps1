...
const QUICK_ALERTS = [
  { label: 'I need help!', msg: 'EMERGENCY: I need immediate help! Please contact me now.' },
  { label: 'Being followed', msg: 'Someone is following me. Please send help or call me now.' },
  { label: 'Medical emergency', msg: 'Medical emergency! Please send help immediately.' },
  { label: 'I am in danger', msg: 'I am in danger. Please call me or send help immediately.' },
];
    ...
    <div className="bg-white rounded-2xl shadow-lg p-6">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-gray-900">Offline Emergency Mode</h2>
            <p className="text-xs text-gray-500">SMS works without internet. Auto-sends when data returns.</p>
          </div>
        </div>
      ...
      <div className={`px-4 py-3 rounded-xl mb-4 text-sm border ${isOnline ? 'bg-green-50 border-green-200 text-green-700' : 'bg-orange-50 border-orange-200 text-orange-800'}`}>
        {isOnline ? (
          <div className="flex items-center justify-between">
            <span>Connected - alerts send instantly</span>
      ...
      {/* Quick alerts */}
      <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Quick Emergency Alerts</p>
...
'@
[System.IO.File]::WriteAllText("src\components\OfflineEmergency.tsx", $content, [System.Text.Encoding]::UTF8)
Write-Host "OfflineEmergency.tsx written successfully!"
